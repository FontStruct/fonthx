...
import fonthx.formats.tt.tables.opentype.lookup.gpos.PairAdjustmentPositioningSubtableFormat1;
import fonthx.formats.tt.tables.opentype.lookup.gpos.PairAdjustmentPositioningSubtableFormat2;
