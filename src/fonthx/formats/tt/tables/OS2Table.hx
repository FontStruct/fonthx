...
class OS2Table extends Table
{
	...
	/**
	   ...
	   Use constants from fonthx.formats.tt.constants.FontSelectionFlags;
	 **/
	...
	/**
        ...
        Use constants from fonthx.formats.tt.constants.Embedding;
        @param embeddingType
	 **/
	...
	/**
        ...
        Use constants from fonthx.formats.tt.constants.Weight;
	 **/
	...
	/**
        ...
        Use constants from fonthx.formats.tt.constants.Width;
	 **/
