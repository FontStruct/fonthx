...
import fonthx.formats.tt.cff.Strings;
import fonthx.model.font.IFont;
import fonthx.formats.tt.writers.ITrueTypeWriter;
import fonthx.formats.tt.tables.Table;
import fonthx.formats.tt.cff.operators.TopDictOps;
import fonthx.formats.tt.cff.CharStrings as CharStringsTable;
using fonthx.formats.tt.cff.Dictionary;
...
class CFF extends Table {
    ...
    override public function write(tt:ITrueTypeWriter) {
        ...
        CharStringsTable.write(tt, font);
    }
}
